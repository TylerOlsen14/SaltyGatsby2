...
class LaurelStreet extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Layout>
        ...
        >
          ...
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISijensahjo2ph1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/IS27azrx8388ph1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISybza81oy2mph1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISizum7ofimrph1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISugomo43uxzph1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISmama6yylp2qh1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/IS6yhm5lq598qh1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISqldy48ipsdqh1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISa99a4v99cjqh1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
          <div>
            <img src="https://photos.zillowstatic.com/p_f/ISuw4m3i1tvoqh1000000000.jpg" alt="Items"/>
            <p className="legend">Legend</p>
          </div>
        </Carousel>
      </Layout>
